...
export type GhostMascotState =
  ...
  | "happy"
  | "sleepy";
export type GhostMessageTrigger =
  | "stuck_drift"
  | "distraction_drift"
  | "frequency_drift"
  | "proactive"
...
export interface DismissNudgePayload {
  action: "acknowledged" | "break";
}
...
export const MOCK_CHAT_HISTORY: ChatEntry[] = [
  {
    role: "ghost",
    content:
      "Noticed you've been cycling between VS Code and Chrome — what's snagging you?",
