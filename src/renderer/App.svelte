<script lang="ts">
  import { screen, recap, activeTask, activeMins, goToSession, goToRecap, goToChat, resetSessionState } from './stores/app';
  import { onMount } from 'svelte';
  import { onSessionUpdate, onOpenGhostChat, onSessionRecap, onNudge, cleanupAllListeners } from './lib/electron';
